...
namespace Rendering
{
    ...
    void createGraphicsPipeline() {
        ...
        VkShaderModule vertShaderModule = Shader::CreateShaderModule(MD_ASSETS_PATH("Shaders/vert.spv"), device);
        VkShaderModule fragShaderModule = Shader::CreateShaderModule(MD_ASSETS_PATH("Shaders/frag.spv"), device);
